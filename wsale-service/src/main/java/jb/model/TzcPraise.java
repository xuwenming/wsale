...
@Entity
@Table(name = "zc_praise")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TzcPraise implements java.io.Serializable,IEntity{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "ZcPraise";
	...
	public boolean equals(Object obj) {
		if(obj instanceof ZcPraise == false) return false;
		if(this == obj) return true;
		ZcPraise other = (ZcPraise)obj;
