  ...
  Datetime.prototype = {
    ...
    getConfig: function() {
      var today = new Date(),
          ...
          self = this,
          lastValidValues;
      // 调整日期默认值 start 2017.6.17
      if(today.getHours() >= 0 && today.getHours() < 10) today.setHours(10);
      else if(today.getHours() >= 10 && today.getHours() < 23) today.setHours(today.getHours() + 1);
      else if(today.getHours() == 23) {
        today.setDate(today.getDate() + 1);
        today.setHours(10);
      }
      today.setMinutes(0);
      // 调整日期默认值 end 2017.6.17
      var config = {
