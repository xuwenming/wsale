...
<!-- 扩展jQuery -->
<script type="text/javascript"
		src="${pageContext.request.contextPath}/jslib/qrcode.js"
		charset="utf-8"></script>
...
<!-- simpleslide插件 -->
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/jslib/simpleslide/simple.slide.css">
<script src="${pageContext.request.contextPath}/jslib/simpleslide/simple.slide.min.js" type="text/javascript" charset="utf-8"></script>
