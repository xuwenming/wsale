	...
	$(function() {
		dataGrid = $('#dataGrid').datagrid({
			...
			columns : [ [ {
				...
				field : 'mtype',
				title : '<%=TzcSysMsg.ALIAS_MTYPE%>',
				width : 50		
				}, {
				field : 'timeUnit',
				title : '<%=TzcSysMsg.ALIAS_TIME_UNIT%>',
				width : 50		
				}, {
				field : 'content',
				title : '<%=TzcSysMsg.ALIAS_CONTENT%>',
				width : 50		
				}, {
				field : 'addtime',
