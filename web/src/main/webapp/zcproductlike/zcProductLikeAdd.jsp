...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/zcProductLikeController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
					<input name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TzcProductLike.FORMAT_ADDTIME%>'})"  maxlength="0" class="span " />
					</td>							
