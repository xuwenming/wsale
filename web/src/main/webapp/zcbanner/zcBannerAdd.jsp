...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/zcBannerController/add',
			onSubmit : function() {
		...
		<form id="form" method="post" enctype="multipart/form-data">
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td colspan="3">
						<input class="easyui-validatebox span2" name="title" type="text" data-options="required:true" style="width: 500px;"/>
					</td>							
				</tr>
				<tr>
					<th width="10%"><%=TzcBanner.ALIAS_SORT_NUMBER%></th>
					<td width="40%">
						<input name="sortNumber" value="100" class="easyui-numberspinner"
				...
				<tr>
					...
					<td colspan="3">
						<input class="span2" name="detailUrl" type="text" style="width: 500px;"/>
					</td>
				</tr>
				<tr>
