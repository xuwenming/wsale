        ...
        <div id="index-content" role="main" class="ui-content jqm-content jqm-fullwidth">
            ...
            <div class="home-content" style="background-color: #FFF;">
                <div>
                    ...
                    <a style="width:31%; display:inline-block;background-color:#fff;padding:15px 0px;border-right: 1px solid #eee;" href="javascript:href('api/apiHomeController/myAttedProduct');">
                    ...
                    <a style="width:31%; display:inline-block;background-color:#fff;padding:15px 0px;" href="javascript:href('api/bbsController/hotBbs');">
                    ...
                    <a style="width:31%; display:inline-block;background-color:#fff;padding:15px 0px;border-left: 1px solid #eee;" href="javascript:href('api/bbsController/hotBbs?bbsType=BT03');">
