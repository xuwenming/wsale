...
<body>
    <div data-role="page" class="jqm-demos" style="background-color:#f5f5f5;">
        <div role="main" class="ui-content jqm-content jqm-fullwidth">
            ...
            <input style="margin:10px;background-color: #fff;" type="text" maxlength="18" placeholder="请输入您的微信号..." id="wechatNo" value="${wechatNo}"/>
        </div><!-- /content -->
    </div><!-- /page -->
    ...
    <script type="text/javascript">
        $(function(){
            $('#saveBtn').click(function(){
                ajaxPost('api/userController/edit', {wechatNo : $('#wechatNo').val()}, function(data){
                    if(data.success) {
