		...
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
											<input class="span2" name="mtype" type="text" value="${zcSysMsg.mtype}"/>
					</td>							
			</tr>	
				<tr>	
					<th><%=TzcSysMsg.ALIAS_TIME_UNIT%></th>	
					<td>
											<input class="span2" name="timeUnit" type="text" value="${zcSysMsg.timeUnit}"/>
					</td>							
					<th><%=TzcSysMsg.ALIAS_CONTENT%></th>	
					<td>
											<input class="span2" name="content" type="text" value="${zcSysMsg.content}"/>
					</td>							
			</tr>	
				<tr>	
