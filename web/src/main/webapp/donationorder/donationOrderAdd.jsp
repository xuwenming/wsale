...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/donationOrderController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
											<input class="span2" name="openid" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
											<input class="span2" name="country" type="text"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TdonationOrder.ALIAS_HEADIMGURL%></th>	
					<td>
											<input class="span2" name="headimgurl" type="text"/>
					</td>							
					<th><%=TdonationOrder.ALIAS_ADDTIME%></th>	
					<td>
					<input class="span2" name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TdonationOrder.FORMAT_ADDTIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
				<tr>	
					...
					<td>
					<input class="span2" name="paytime" type="text" onclick="WdatePicker({dateFmt:'<%=TdonationOrder.FORMAT_PAYTIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
				<tr>	
