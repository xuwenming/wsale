...
<script type="text/javascript">
	...
	var imageSlide = {
		initImageSlide : function(images) {
			if(!images) return;
			$('.showImageSlide').empty();
			images.each(function(){
				$('.showImageSlide').append($(this).clone());
			});
			$('.showImageSlide img').simpleSlide();
		},
		showImageSlide : function(index) {
			index = index || 0;
			$('.showImageSlide img:eq('+index+')').click();
		}
