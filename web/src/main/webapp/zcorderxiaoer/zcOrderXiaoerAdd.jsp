...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/zcOrderXiaoerController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
					<input name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TzcOrderXiaoer.FORMAT_ADDTIME%>'})"  maxlength="0" class="span " />
					</td>							
				...
				<tr>	
					...
					<td>
					<input name="updatetime" type="text" onclick="WdatePicker({dateFmt:'<%=TzcOrderXiaoer.FORMAT_UPDATETIME%>'})"  maxlength="0" class="span " />
					</td>							
				</tr>	
			</table>		
		</form>
