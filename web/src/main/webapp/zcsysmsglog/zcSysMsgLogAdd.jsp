...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/zcSysMsgLogController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
											<input class="span2" name="sysMsgId" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
											<input class="span2" name="timeUnit" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
					<input name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TzcSysMsgLog.FORMAT_ADDTIME%>'})"  maxlength="0" class="span " />
					</td>							
				</tr>	
			</table>		
		</form>
